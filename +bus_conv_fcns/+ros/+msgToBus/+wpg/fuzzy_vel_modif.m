function slBusOut = fuzzy_vel_modif(msgIn, slBusOut, varargin)
%#codegen
%   Copyright 2021 The MathWorks, Inc.
    ...
    slBusOut.DistanceToObstacle = double(msgIn.DistanceToObstacle);
    slBusOut.DistanceToObjective = double(msgIn.DistanceToObjective);
