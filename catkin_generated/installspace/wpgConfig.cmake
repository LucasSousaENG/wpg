...
if("FALSE" STREQUAL "TRUE")
  set(wpg_SOURCE_PREFIX /home/lucas/catkin_ws/src/wpg)
  set(wpg_DEVEL_PREFIX /home/lucas/catkin_ws/devel)
  set(wpg_INSTALL_PREFIX "")
  set(wpg_PREFIX ${wpg_DEVEL_PREFIX})
else()
  set(wpg_SOURCE_PREFIX "")
  set(wpg_DEVEL_PREFIX "")
  set(wpg_INSTALL_PREFIX /home/lucas/catkin_ws/install)
...
if(NOT "include " STREQUAL " ")
  ...
  elseif(NOT " " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'piradata <guilhermefercar@gmail.com>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'wpg' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '\${prefix}/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT wpg_NUM_DUMMY_TARGETS)
      set(wpg_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::wpg::wrapped-linker-option${wpg_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR wpg_NUM_DUMMY_TARGETS "${wpg_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::wpg::wrapped-linker-option${wpg_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND wpg_LIBRARIES "${interface_target_name}")
...
set(wpg_EXPORTED_TARGETS "wpg_generate_messages_cpp;wpg_generate_messages_eus;wpg_generate_messages_lisp;wpg_generate_messages_nodejs;wpg_generate_messages_py")
